...
handler.before = function (m) {
  ...
  let role =
    user.level <= 2
      ...
      ? 'Legendary 忍忍忍忍'
      : user.level >= 1000 && user.level <= 2000
      ? 'Master 숒 ×'
      : user.level >= 4000 && user.level <= 5000
      ? 'Master 숒숒 ×'
      : user.level >= 7000 && user.level <= 10000
      ? 'Star Master 숒'
      : user.level >= 10000 && user.level <= 12000
      ? 'Star Master 숒숒'
      : user.level >= 12000 && user.level <= 15000
      ? 'Star Master 숒숒숒'
      : user.level >= 15000 && user.level <= 20000
      ? 'Star Master 숒숒숒숒'
      : user.level >= 20000 && user.level <= 22000
      ? 'Bronze Crown ★'
      : user.level >= 22000 && user.level <= 25000
      ? 'Bronze Crown ★★'
      : user.level >= 25000 && user.level <= 27000
      ? 'Bronze Crown ★★★'
      : user.level >= 27000 && user.level <= 30000
      ? 'Bronze Crown ★★★★'
      : user.level >= 30000 && user.level <= 32000
      ? 'Silver Crown ★'
      : user.level >= 32000 && user.level <= 35000
      ? 'Silver Crown ★★'
      : user.level >= 35000 && user.level <= 37000
      ? 'Silver Crown ★★★'
      : user.level >= 37000 && user.level <= 40000
      ? 'Diamond Crown 戈 '
      : user.level >= 40000 && user.level <= 42000
      ? 'Diamond Crown 戈心 '
      : user.level >= 45000 && user.level <= 50000
      ? 'King ❀'
      : 'GOD 亗';
  user.role = role;
  return true;
