...
`.trim()  
        ...
        case 'pet':
            ...
            let penguin = global.DATABASE._data.users[m.sender].penguin
            let _pet = `${pickRandom(['kucing', 'rubah', 'kuda', 'anjing', 'sapi', 'kambing', 'penguin'])}`.trim()
            if (global.DATABASE._data.users[m.sender].pet > 0) { 
                ...
                } else if (_pet == 'badak' && badak > 0) {
                    global.DATABASE._data.users[m.sender].potion += 2
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`, m)
                } else if (_pet == 'badak' && badak == 0) {
                    global.DATABASE._data.users[m.sender].badak += 1
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)

                } else if (_pet == 'nemo' && nemo > 0) {
                    global.DATABASE._data.users[m.sender].potion += 2
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`, m)
                } else if (_pet == 'nemo' && nemo == 0) {
                    global.DATABASE._data.users[m.sender].nemo += 1
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)

                } else if (_pet == 'kambing' && kambing > 0) {
                    global.DATABASE._data.users[m.sender].potion += 2
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion ${mknp > 0 ? `Dan ${mknp} Makanan Pet` : ''}`, m)
                } else if (_pet == 'kambing' && kambing == 0) {
                    global.DATABASE._data.users[m.sender].kambing += 1
                    global.DATABASE._data.users[m.sender].makananpet += mknp * 1
                    conn.reply(m.chat, `*Selamat Anda mendapatkan pet ${_pet}${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : '*'}`, m)
