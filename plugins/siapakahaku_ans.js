...
handler.before = async function (m) {
    ...
    if (m.quoted.id == this.siapakahaku[id][0].id) {
        ...
        if (m.text.toLowerCase() == json.jawaban.toLowerCase().trim()) {
            ...
            global.DATABASE.data.users[m.sender].misievent1 += 1
            await this.sendButton(m.chat, `*Selamat Jawaban Kamu Benar! ✅* Dan Mendapatkan +${this.siapakahaku[id][2]} XP`, '© Nekohime', 'Siapakah Aku', '.siapaaku', m)
